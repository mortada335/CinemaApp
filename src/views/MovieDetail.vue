      ...
      <v-row justify="center">
        <v-col cols="12" sm="9">
          <v-card outlined class="pa-2">
            ...
            <v-card-actions>
              <v-btn text size="small" color="primary" @click="fetchTrailer">Show Trailer</v-btn>

              <v-btn size="small" @click="toggleFavorite(movie)" :color="isFavorite(movie) ? 'red' : 'primary'">
